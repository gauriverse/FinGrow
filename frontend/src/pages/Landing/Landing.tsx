    ...
    <div className="min-h-screen bg-[#FAF9F5] text-slate-800 font-sans selection:bg-brand-lightGreen">
      ...
      <nav className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight font-serif text-[#0F4C3A]">FinGrow</span>
        </div>

        {/* Navigation Links */}
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
          <a href="#features" className="hover:text-[#0F4C3A] transition">Features</a>
          <a href="#how-it-works" className="hover:text-[#0F4C3A] transition">How it works</a>
          <a href="#learn" className="hover:text-[#0F4C3A] transition">Learn</a>
          <a href="#about" className="hover:text-[#0F4C3A] transition">About</a>
        </div>

        {/* Auth Buttons */}
        <div className="flex items-center gap-3">
          <Link to="/login" className="px-5 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-lg transition border border-transparent">
            Log in
          </Link>
          <button type="button" className="px-5 py-2.5 text-sm font-medium text-white bg-[#0F4C3A] hover:bg-[#0b382a] rounded-lg transition flex items-center gap-1">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-12 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          <h1 className="text-5xl md:text-6xl font-serif font-bold text-slate-900 leading-[1.1] tracking-tight">
            Learn to invest.<br />
            <span className="text-[#0F4C3A] italic font-normal">Risk nothing.</span>
          </h1>
          <p className="text-base text-slate-600 max-w-lg leading-relaxed">
            Al-powered paper trading that explains every recommendation in plain English — practice with ₹10,00,000 in virtual capital before a rupee of your own is on the line.
          </p>
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button className="px-6 py-3.5 text-sm font-semibold text-white bg-[#0F4C3A] hover:bg-[#0b382a] rounded-md transition shadow-sm flex items-center gap-1">
        ...
        <div className="lg:col-span-6 flex justify-center lg:justify-end">
          <div className="w-full max-w-lg bg-white rounded-2xl p-6 shadow-[0_15px_30px_rgba(0,0,0,0.04)] border border-slate-100">
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] tracking-widest text-slate-400 font-bold uppercase">Portfolio Value</span>
            ...
            <div className="flex items-start gap-2.5 pt-4 border-t border-slate-100">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-serif italic">
                "Recommended TCS for its RSI recovery and your Tech sector preference."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#0C1C2C] text-white py-14">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-slate-800">
          <div className="py-4 md:py-0">
            <h3 className="text-3xl font-bold font-mono tracking-tight text-white mb-1">₹10,00,000</h3>
            <p className="text-xs text-slate-400 font-medium tracking-wide">virtual capital to start</p>
          </div>
          <div className="py-4 md:py-0">
            <h3 className="text-3xl font-bold font-mono tracking-tight text-white mb-1">100%</h3>
            <p className="text-xs text-slate-400 font-medium tracking-wide">of recommendations explained</p>
          </div>
          <div className="py-4 md:py-0">
            <h3 className="text-3xl font-bold font-mono tracking-tight text-white mb-1">0</h3>
            <p className="text-xs text-slate-400 font-medium tracking-wide">real rupees at risk</p>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-6 py-24">
        <div className="max-w-2xl mb-12">
          <h2 className="text-3xl font-serif font-bold text-slate-900 mb-3">How it works</h2>
          <p className="text-sm text-slate-500 leading-relaxed">
            Four steps from "I know nothing about the market" to trading with a real strategy behind you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-100 hover:shadow-md transition">
            <span className="text-xs font-mono text-emerald-600 block mb-3 font-semibold">01</span>
            <h4 className="text-sm font-bold text-slate-900 mb-2">Set your profile</h4>
          ...
          {/* Step 2 */}
          <div className="bg-white rounded-xl p-6 border border-slate-100 hover:shadow-md transition">
            <span className="text-xs font-mono text-emerald-600 block mb-3 font-semibold">02</span>
            <h4 className="text-sm font-bold text-slate-900 mb-2">Get AI picks</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          {/* Step 3 */}
          <div className="bg-white rounded-xl p-6 border border-slate-100 hover:shadow-md transition">
            <span className="text-xs font-mono text-emerald-600 block mb-3 font-semibold">03</span>
            <h4 className="text-sm font-bold text-slate-900 mb-2">Practice trading</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          {/* Step 4 */}
          <div className="bg-white rounded-xl p-6 border border-slate-100 hover:shadow-md transition">
            <span className="text-xs font-mono text-emerald-600 block mb-3 font-semibold">04</span>
            <h4 className="text-sm font-bold text-slate-900 mb-2">Learn as you go</h4>
            <p className="text-xs text-slate-500 leading-relaxed">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-100 space-y-4 hover:shadow-md transition">
            ...
            <h3 className="text-base font-bold text-slate-900">Explainable AI</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Every pick comes with the plain-English reason behind it — not just a buy signal.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-100 space-y-4 hover:shadow-md transition">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Run your own picks side-by-side with the AI's and see who's actually right.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-100 space-y-4 hover:shadow-md transition">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Bite-sized lessons that appear exactly when a concept trips you up.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-200/50 py-10 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-base tracking-tight font-serif text-[#0F4C3A]">FinGrow</span>
          </div>

          <p className="text-[11px] text-slate-400 max-w-sm text-center sm:text-right leading-normal">
            Virtual money only. Nothing on FinGrow is financial advice — it's a practice ground for learning how markets work.
          </p>
        </div>
      </footer>
